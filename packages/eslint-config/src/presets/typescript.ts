      ...
      rules: {
        ...
        '@typescript-eslint/ban-types': [
          'error',
          {
            types: {
              Function:
                "Don't use Function as a type. Use explicit types like `(...args: unknown[]) => void`.",
        ...
        '@typescript-eslint/consistent-generic-constructors': ['error', 'constructor'], // Enforces specifying generic type arguments on type annotation or constructor name of a constructor call
        ...
        '@typescript-eslint/no-duplicate-enum-values': 'error', // disallows duplicate enum member values
        ...
        '@typescript-eslint/parameter-properties': 'error', // disallow the use of parameter properties in class constructors
